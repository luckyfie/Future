module.exports = {
    ...
    execute(message, args, cmd, client, discord) {
        ...
        const logEmbed = new discord.MessageEmbed()
            .setColor('ff0000')
            .setAuthor(message.author.tag, message.author.displayAvatarURL({ dynamic: true }))
            .setDescription(`${message.author.tag} heeft een bericht gestuurd naar  ${servStatusChannelTag} met als bericht Server Geopend:  ${messageArgs}!`)
